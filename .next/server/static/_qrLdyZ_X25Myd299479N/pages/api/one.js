...
module.exports = __webpack_require__("to4r");
...
/* harmony import */ var _qu_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("i10e");
var _qu_json__WEBPACK_IMPORTED_MODULE_0___namespace = /*#__PURE__*/__webpack_require__.t("i10e", 1);

console.log(_qu_json__WEBPACK_IMPORTED_MODULE_0__);
/* harmony default export */ __webpack_exports__["default"] = ((req, res) => {
  console.log(req.cookies);
  res.setHeader('Set-Cookie', ['type=ninja', 'age=23']);

  if (req.cookies) {
    res.status(200).json(req.cookies);
  }

  res.status(200).json(_qu_json__WEBPACK_IMPORTED_MODULE_0__);
});
